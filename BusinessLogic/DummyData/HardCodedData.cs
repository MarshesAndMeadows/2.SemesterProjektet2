...
namespace BusinessLogic.DummyData
{
    internal class HardCodedData
    {
        ...
        private void LoadData()
        {
            ...
            service3 = new Service { ServiceName = "Retshjælp", Description = "Hjælp og repræsentation i retssager såsom retssager og høringer.", OneTimePayment = true, StartPaymentDefault = 15000, UnitCostDefault = 0 };
            ...
            service5Special = new Service { ServiceName = "Mediation", Description = "Facilitering af forhandlinger mellem parterne for at nå gensidigt acceptable aftaler.", OneTimePayment = false, StartPaymentDefault = 5000.0, UnitCostDefault = 250.0 };

            // AppliedServices:
            appliedService1 = new AppliedService { Note = "Journalnotat1", StartPaymentActual = 0, UnitCount = 3, UnitCostActual = 900, ServicePerformed = new DateTime(2024, 2, 28), Service = service1Special, Lawyer = lawyer1 };
            appliedService2 = new AppliedService { Note = "Journalnotat2", StartPaymentActual = 0, UnitCount = 5, UnitCostActual = 1000, ServicePerformed = new DateTime(2024, 2, 28), Service = service1Special, Lawyer = lawyer1 };
            appliedService3 = new AppliedService { Note = "Journalnotat3", StartPaymentActual = 0, UnitCount = 10, UnitCostActual = 850, ServicePerformed = new DateTime(2024, 2, 28), Service = service1Special, Lawyer = lawyer1 };
            appliedService4 = new AppliedService { Note = "Journalnotat4", StartPaymentActual = 0, UnitCount = 6, UnitCostActual = 1000, ServicePerformed = new DateTime(2024, 2, 28), Service = service1Special, Lawyer = lawyer2 };
            appliedService5 = new AppliedService { Note = "Journalnotat5", StartPaymentActual = 20000, UnitCount = 0, UnitCostActual = 0, ServicePerformed = new DateTime(2024, 2, 28), Service = service2, Lawyer = lawyer2 };
            appliedService6 = new AppliedService { Note = "Journalnotat6", StartPaymentActual = 19000, UnitCount = 0, UnitCostActual = 0, ServicePerformed = new DateTime(2024, 2, 28), Service = service2, Lawyer = lawyer3 };
            appliedService7 = new AppliedService { Note = "Journalnotat7", StartPaymentActual = 15000, UnitCount = 0, UnitCostActual = 0, ServicePerformed = new DateTime(2024, 2, 28), Service = service3, Lawyer = lawyer3 };
            appliedService8 = new AppliedService { Note = "Journalnotat8", StartPaymentActual = 13500, UnitCount = 0, UnitCostActual = 0, ServicePerformed = new DateTime(2024, 2, 28), Service = service3, Lawyer = lawyer4 };
            appliedService9 = new AppliedService { Note = "Journalnotat9", StartPaymentActual = 0, UnitCount = 12, UnitCostActual = 750, ServicePerformed = new DateTime(2024, 2, 28), Service = service4Special, Lawyer = lawyer5 };
            appliedService10 = new AppliedService { Note = "Journalnotat10", StartPaymentActual = 5000, UnitCount = 7, UnitCostActual = 250, ServicePerformed = new DateTime(2024, 2, 28), Service = service5Special, Lawyer = lawyer6 };
